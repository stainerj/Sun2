...
public class SunCalculator6 {
    ...
    public static double solarTransit() {
        ...
        do {
            ...
            System.out.println("NEW HOUR ANGLE IS ------------------------------------------------------------- " + hourAngle);// should reduce/tend to zero with iterations

            System.out.println("Time of transit (Julian Day) -------------------------------------------------- " + jTransit);
            jTransit = jTransit - (hourAngle/360);
            System.out.println("REPETITION METHOD value of Time of Transit is --------------------------------- " + jTransit);
    ...
    public static void riseAndSet() {
        ...
        jRise = jTransit - (radiansToDegrees(H)/360);//repetition method available
        System.out.println("Time of sunrise (Julian day) -------------------------------------------------- " + jRise);
        //Jset = jTransit + H/360 (*J3=1)
        jSet = jTransit + (radiansToDegrees(H)/360);//repetition method available
